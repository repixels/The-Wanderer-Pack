 ...
 * @author Ehab
 */
@WebFilter(filterName = "LoginFilter", urlPatterns = {"/Admin/index.jsp","/Admin/add-category.jsp","/Admin/add-product.jsp","/Admin/add-category.jsp","/Admin/products.jsp","/Admin/categories.jsp"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.INCLUDE})
