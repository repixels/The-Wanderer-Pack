                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls">
                                        <li><a href="add-product.html"><span class="fa fa-plus"></span></a></li>
                                    </ul>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="trow_${product.productId}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row('trow_${product.productId}',${product.productId}+'');"><span class="fa fa-times"></span></button>
                                                    </td>
                                                </tr>
                                                </c:forEach>
                                            </tbody>
